  ...
  <section class="container ">
  		<div class="container">
    			<div class="row align-items-center my-5">
            			...
            			<img src="images/register.png" alt="" class="img-fluid mb-3 d-none d-md-block">   
				           ...
				           <form  modelAttribute="user" method="POST">
				             ...
				             <!-- Role -->
				                    <div class="input-group col-lg-12 mb-4">
				                        ...
				                        <select id="type" name="role" class="form-control custom-select bg-white border-left-0 border-md" required>
				                ...
				                <div class="row">
				                    ...
				                    <div class="input-group col-lg-6 mb-4">
				                        ...
				                        <input id="confirmPassword" type="password" oninput="checkInputs();"name="conformPassword" placeholder="Confirm Password" class="form-control bg-white border-left-0 border-md" required>
				                    </div>
