...
<div id="content">
	...
	<section class="container ">
		<div class="container">
			...
			<h1 style="text-align: center;  color: maroon;">Edit Events</h1>
			</div>
				<!-- For Demo Purpose -->
				...
				<c:choose>
					...
					<c:when test="${!empty eventDtls }">
						<table class="table table-striped">
							...
							<c:forEach var="eve" items="${eventDtls }">
								<tbody>
									<tr>
										...
										<td><a href="edit?id=${eve.id }"><button class="btn btn-primary"><i class="fa-solid fa-user-pen"></i></button></a></td>
										<td><a
											onclick="return confirm('You Want To Delete Event !')"
											href="delete?id=${eve.id }"><button class="btn btn-danger"><i class="fa-solid fa-trash"></i></button></a></td>
									</tr>
								</tbody>
